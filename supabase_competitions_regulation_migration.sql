...
ALTER TABLE public.competitions
  ...
  ADD COLUMN IF NOT EXISTS foreign_regulation_free BOOLEAN,
...
SET
  ...
  foreign_regulation_free = COALESCE(foreign_regulation_free, false),
...
ALTER TABLE public.competitions
  ...
  ALTER COLUMN foreign_regulation_free SET DEFAULT false,
...
ALTER TABLE public.competitions
  ...
  ALTER COLUMN foreign_regulation_free SET NOT NULL,
